...
// ==================== LEGACY HTML PAGES ====================
// These routes must come BEFORE express.static and the catch-all (*)
// so they are always matched correctly by Express.
// Only specific safe files are exposed — .env and data/ are NOT served.
